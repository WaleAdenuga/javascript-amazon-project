...
// built-in classes
// we used dayjs which uses date but it gives extra features so worth it
// const date = new Date();
// console.log(date.toLocaleTimeString());

/* console.log(this); // outside an object returns undefined
...
export function loadProducts(func) {
  ...
  // another callback just for error handling
  // error parameter handles errors
